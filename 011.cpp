...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48)";
    ...
    for (int r = 0; r < 20; r++)
    {
        ...
        {
            if (r + 3 < 20)
                max_product = std::max(max_product, numbers[r][c] * numbers[r + 1][c] * numbers[r + 2][c] * numbers[r + 3][c]);
            if (c + 3 < 20)
                max_product = std::max(max_product, numbers[r][c] * numbers[r][c + 1] * numbers[r][c + 2] * numbers[r][c + 3]);
            if (r + 3 < 20 && c + 4 < 20)
                max_product = std::max(max_product, numbers[r][c] * numbers[r + 1][c + 1] * numbers[r + 2][c + 2] * numbers[r + 3][c + 3]);
            if (r + 3 < 20 && c - 3 >= 0)
                max_product = std::max(max_product, numbers[r][c] * numbers[r + 1][c - 1] * numbers[r + 2][c - 2] * numbers[r + 3][c - 3]);
        }
    }
